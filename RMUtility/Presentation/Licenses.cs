...
public sealed partial class Licenses : Page
{
    public Licenses()
    {
        this.DataContext<BindableLicensesModel>((page, vm) => page
                        ...
                        new AutoLayout()
                            ...
                            (
                                ...
                                new FeedView()
                                    ...
                                    .Margin(0, 12)
                                    .NoneTemplate(LicenseNoneTemplate)
                                    .ErrorTemplate(LicenseErrorTemplate)
                                    .ValueTemplate<FeedViewState>(feedViewState =>
                                        new ListView()
                                            .ItemsSource(() => feedViewState.Data)
                                            .Padding(12, 8)
                                            .SelectionMode(ListViewSelectionMode.Single)
                                            .Navigation(request: Consts.Routes.License)
                                            ...
                                            .ItemTemplate<License>(LicenseItemTemplate)
                                    )
                              )
                        )
                 )
    ...
    private static UIElement LicenseErrorTemplate() =>
        new AutoLayout()
                .Spacing(8)
    ...
    private static UIElement LicenseNoneTemplate() =>
        new AutoLayout()
                .Spacing(24)
                .PrimaryAxisAlignment(AutoLayoutAlignment.Center)
                .CounterAxisAlignment(AutoLayoutAlignment.Center)
                    ...
                    new AutoLayout()
                        ...
                        (
                            new TextBlock()
                                ...
                                .Style(Theme.TextBlock.Styles.HeadlineSmall),
                            new TextBlock()
                                .Text("Try a new search string")
                                .Foreground(Theme.Brushes.OnSurface.Medium)
                                .Style(Theme.TextBlock.Styles.BodyLarge)
                        )
                );

    private static UIElement LicenseItemTemplate(License license) =>
    new Border()
        .CornerRadius(12)
        .Padding(6)
            ...
            new Grid()
                ...
                (
                    ...
                    new TextBlock()
                        ...
                        .Text(() => license.Name)
                        .Height(18)
                        .Foreground(Theme.Brushes.Primary.Medium)
                        .Style(Theme.TextBlock.Styles.LabelMedium)
                        .HorizontalAlignment(HorizontalAlignment.Left)
                        .VerticalAlignment(VerticalAlignment.Center),
                    new TextBlock()
                        .Grid(column: 1, row: 0)
                        .Text(() => license.ProductTypeName)
                        .Height(18)
                        .Foreground(Theme.Brushes.OnSurface.Medium)
                        .Style(Theme.TextBlock.Styles.LabelMedium)
